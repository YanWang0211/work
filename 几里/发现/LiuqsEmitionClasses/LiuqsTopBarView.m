...
- (UIButton *)topBarEmotionBtn {
    ...
    if (!_topBarEmotionBtn) {
        ...
        [_topBarEmotionBtn setImage:[UIImage imageNamed:@"chatroom_emoji"] forState:UIControlStateNormal];
        [_topBarEmotionBtn setImage:[UIImage imageNamed:@"chatroom_keyboard"] forState:UIControlStateSelected];
